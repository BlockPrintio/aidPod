 ...
 * @returns A valid testnet address format
 */
export function generateSampleTestnetAddress(): string {
 ...
 * @param campaignData - Campaign data with addresses
 * @returns Validation result with errors
 */
export function validateCampaignAddresses(campaignData: CampaignData): ValidationResult {
 ...
 */
export function formatAddressForDisplay(address: string, startChars: number = 8, endChars: number = 8): string {
